...
namespace FidgetPro.Fidgetmaster.Business.Migrations
{
    ...
    [Migration("20190813201406_SeedFidget")]
    partial class SeedFidget
    {
            ...
            modelBuilder.Entity("FidgetPro.Fidgetmaster.Business.Models.FidgetType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            DesignedDate = new DateTime(2019, 8, 13, 20, 14, 6, 486, DateTimeKind.Utc).AddTicks(351),
                            IsBouncing = false,
                            IsFlying = true,
                            IsSpinning = true,
                        ...
                        {
                            Id = 2L,
                            DesignedDate = new DateTime(2019, 8, 13, 20, 14, 6, 486, DateTimeKind.Utc).AddTicks(2193),
                            IsBouncing = true,
                            IsFlying = false,
                            IsSpinning = true,
                        ...
                        {
                            Id = 3L,
                            DesignedDate = new DateTime(2019, 8, 13, 20, 14, 6, 486, DateTimeKind.Utc).AddTicks(2206),
                            IsBouncing = false,
                            IsFlying = false,
                            IsSpinning = false,
                            TypeName = "Chad"
